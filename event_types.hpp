...
const event_type event_types[]= {
    ...
    {28, 1, "BPMVOL"}, // хз че тут было 2
    {29, 2, "SOUNDVOL"}, // неудобно менять звука громкость так что сделал так
    ...
    {43, 1, "SHOW"}, // show sprite {id}
    {44, 1, "DEL"}, // deletes sprite {id}
    {44, 0, "DELSPRITES"}, // delete all sprites
