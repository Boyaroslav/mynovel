...
*/
    ...
    private void setupEnvironment() {
        try {
            ...
            File ccnvlFile = new File(getFilesDir(), "test2.ccnvl");

            if (!ccnvlFile.exists()) {
                try (InputStream in = getAssets().open("test2.ccnvl");
                    FileOutputStream out = new FileOutputStream(ccnvlFile)) {
            ...
            File saveFile = new File(getFilesDir(), "quick_save.ccsave");

            SDLActivity.nativeSetenv(
                "CCNVL_FILE",
                ccnvlFile.getAbsolutePath()
            );
            ...
            Log.v(TAG, "CCNVL_FILE=" + ccnvlFile.getAbsolutePath());
            Log.v(TAG, "QSAVE_FILE=" + saveFile.getAbsolutePath());
